...
- Static accumulated Policy validation in Strategy composition through `ValidateWith<P>`.
- Optional `validation_policy!` shorthand for existing policy markers backed by `Default`-constructible rules.
